...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'surgeon_surgeon', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('institution', self.gf('django.db.models.fields.CharField')(max_length=90)),
            ('cases', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CaseEntry.Case'])),
        ))
        db.send_create_signal(u'surgeon', ['Surgeon'])


    def backwards(self, orm):
        # Deleting model 'Surgeon'
        db.delete_table(u'surgeon_surgeon')
    ...
    models = {
        ...
        u'CaseEntry.caseform': {
            ...
            'treatment_center_travel_cost': (
            'django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'urine_leak_amount': (
            'django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'urine_leak_frequency': (
            'django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        u'surgeon.surgeon': {
            ...
            'cases': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['CaseEntry.Case']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
