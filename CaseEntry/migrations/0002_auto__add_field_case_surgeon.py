...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.surgeon'
        db.add_column(u'CaseEntry_case', 'surgeon',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surgeon.Surgeon'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.surgeon'
        db.delete_column(u'CaseEntry_case', 'surgeon_id')
    ...
    models = {
        u'CaseEntry.case': {
            ...
            'surgeon': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['surgeon.Surgeon']", 'null': 'True', 'blank': 'True'}),
